                ...
                <form action="{{ route('products.store') }}" method="POST" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="md:col-span-2">
                            <x-form-input label="Name" name="name" type="text" :required="true" placeholder="Product name" />
                        </div>

                        <div class="md:col-span-2">
                            <x-form-input label="Description" name="description" type="textarea" placeholder="Product description" />
                        </div>

                        <x-form-input label="Unit Price" name="unit_price" type="number" :required="true" step="0.01" placeholder="0.00" />
